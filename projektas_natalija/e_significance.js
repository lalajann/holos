...
function gotData(data) {
    ...
    for (var i = 0; i < earthquakes.length; i++) {
        ...
        dydis = earthquakes[i].properties.sig;
...
function showStatistika() {
    parent = createDiv('place' + ' / ' + 'significance')
    parent.addClass('parent')
    significant = createDiv('significant earthquake > 600')
    significant.parent(parent)
    significant.style('font-size', '14px')
    let metai = year();
    let menuo = month();
    let diena = day();
