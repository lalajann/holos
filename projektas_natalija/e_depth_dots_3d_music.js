...
function gotData(data) {
    ...
    for (var i = 0; i < earthquakes.length; i++) {
        dydis = earthquakes[i].geometry.coordinates[2];
        place = earthquakes[i].place;
...
function showStatistika() {
    parent = createDiv('place' + ' / ' + 'earthquake depth')
    ...
    for (var i = 0; i < earthquakes.length; i++) {
        dydis = round(earthquakes[i].geometry.coordinates[2], 2);
